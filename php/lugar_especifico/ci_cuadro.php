...
class ci_cuadro extends saludytrabajo_ci
{
	function conf__cuadro(toba_ei_cuadro $cuadro)
	{
		...
		$cuadro->set_datos($consulta->get_solo_lugar_trabajo_especifico($usuario));
	...
	{
		$consulta = new Consultas();    
		$grafico->conf()->canvas__set_titulo("Distribución por Estamento de los encuestados");
		$usuario = texto_plano(toba::usuario()->get_id());
		$datos =  $consulta->get_estamento($usuario);
