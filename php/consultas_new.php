...
";
				...
				$sql = "select '0 a 10' as antiguedad, 
                count(*) as cantidad, 
                ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) as porcentaje, 
                (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_ingreso) ) ) <=10) as porc_acum  
...
ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) as porcentaje, 
(select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_ingreso) ) ) between -1 and 20) as porc_acum  
from tra_sal_justicia_arg where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_ingreso) ) ) between 11 and 20 and usuario like '".$usuario."'
...
ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) as porcentaje, 
(select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_ingreso) ) ) between-1 and 30) as porc_acum  
from tra_sal_justicia_arg where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_ingreso) ) ) between 21 and 30 and usuario like '".$usuario."'
...
}else
{
    ...
    count(*) as cantidad, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg ),2) 
	from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 25) as porcentaje, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) 
    from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 25) as porc_acum  
    from tra_sal_justicia_arg where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 25 and usuario like '".$usuario."'
    ...
    count(*) as cantidad, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg  ),2) 
	from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 35) as porcentaje, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) 
    from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 35) as porc_acum  
    from tra_sal_justicia_arg where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 26 and 35 and usuario like '".$usuario."'
    ...
    count(*) as cantidad, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg ),2) 
	from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 55)   as porcentaje, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg ),2) 
    from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 0 and 55) as porc_acum  
    from tra_sal_justicia_arg where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) between 36 and 55 and usuario like '".$usuario."'
    ...
    count(*) as cantidad, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg ),2) 
	from tra_sal_justicia_arg as e1 where EXTRACT(YEAR FROM age(timestamp 'now()',date(fecha_nacimiento) ) ) > 55) as porcentaje, 
    (select ROUND(cast(100*count(*) as numeric(10,2))/ (select count(*) from tra_sal_justicia_arg),2) 
    from tra_sal_justicia_arg as e1  ) as porc_acum  
